...
<channel>
 <title>$FILE</title>
 <description>autogenerated on $(hostname) at $(date)</description>
 <language>en-us</language>
 <link>$URLPREFIX</link>
 <image>
   <url>$URLPREFIX/image.png</url>
   <title>favicon</title>
 </image>
...
$DESCRIPTION</description>" >> "$OUTFILE"
	...
	echo '<enclosure url="'"$URLPREFIX$l"'" length="'$CONTENT_LENGTH'" type="'$CONTENT_TYPE'" />' >> "$OUTFILE"
